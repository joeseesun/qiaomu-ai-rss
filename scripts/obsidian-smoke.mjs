...
record('Reader avoids tooltip-triggering accessibility attributes', run(`const root=document.querySelector('.qrs-root'),save=root.querySelector('[data-qrs-label="保存为笔记"]');return JSON.stringify(root.querySelectorAll('[aria-label]').length===0&&save?.querySelector('.qrs-visually-hidden')?.textContent==='保存为笔记');`));
